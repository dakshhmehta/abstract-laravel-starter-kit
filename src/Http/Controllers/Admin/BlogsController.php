...
class BlogsController extends AdminController {
	...
	public function getIndex()
	{
		...
		// Show the page
		return View::make('kit::backend.blogs.index', compact('posts'));
	}
	...
	{
		// Show the page
		return View::make('kit::backend.blogs.create');
	}
	...
	public function getEdit($postId = null)
	{
		...
		if (is_null($post = Post::find($postId)))
		{
			...
			return Redirect::to('admin/blogs')->with('error', Lang::get('kit::admin/blogs/message.does_not_exist'));
		}

		// Show the page
		return View::make('kit::backend.blogs.edit', compact('post'));
	}
	...
	public function postEdit($postId = null)
	{
		...
		{
			// Redirect to the new blog post page
			return Redirect::to("admin/blogs/$postId/edit")->with('success', Lang::get('kit::admin/blogs/message.update.success'));
		}

		// Redirect to the blogs post management page
		return Redirect::to("admin/blogs/$postId/edit")->with('error', Lang::get('kit::admin/blogs/message.update.error'));
	}
	...
	public function getDelete($postId)
	{
		...
		{
			// Redirect to the blogs management page
			return Redirect::to('admin/blogs')->with('error', Lang::get('kit::admin/blogs/message.not_found'));
		}
		...
		return Redirect::to('admin/blogs')->with('success', Lang::get('kit::admin/blogs/message.delete.success'));
	}
